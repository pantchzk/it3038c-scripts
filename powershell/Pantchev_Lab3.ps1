...
$USER = $env:USERNAME
$BODY = ("This machine's IP is $IP. The current user is $USER. This computer's hostname is $NAME. My current major version of Powershell is $MAJORVERSION. Today's day is $DAYOFWEEK, $DATE.")
